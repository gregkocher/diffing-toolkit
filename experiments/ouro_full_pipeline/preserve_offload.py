"""Preserve and optionally stop only the explicitly assigned Ouro offload pod."""
import argparse
...
POD_ID = 'c1k2dey6wp2v52'
POD_NAME = 'CLAUDE_POD_GREG---ouro-full-20260915-offload'

QUIESCENCE_CHECK = r"""
import json
from pathlib import Path
campaign=Path('/workspace/full_audit_offload_20260915')
pool=campaign/'workers/external_pool_v2_native_single'
...
def main():
    ...
    if receipt.exists():
        ...
        source = REMOTE.replace('full_audit_20260915', 'full_audit_offload_20260915')
    ...
    archive = a.output/'full_audit_offload_20260915_export.tar.zst'
